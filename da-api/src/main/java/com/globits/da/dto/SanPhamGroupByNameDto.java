...
public class SanPhamGroupByNameDto extends BaseObjectDto {
	private UUID idSP;
	...
	public SanPhamGroupByNameDto() {

	}

	public SanPhamGroupByNameDto(UUID idSP, String tenSP, ThuocTinhSanPham size, Long soLuong) {
		this.idSP = idSP;
		this.tenSP = tenSP;
		if(size != null) {

...
class SelectUserDepartment extends React.Component {
  ...
  updatePageData = () => {
    ...
    searchObject.keyword = this.props.receiverDepartmentId
      ? this.props.receiverDepartmentId
      : this.state.keyword;
  ...
  selectDepartment = (item) => {
    this.setState({ department: item ? item : null }, function () {
      ...
      var searchObject = {};
      searchObject.keyword = this.state.department
    ...
    let columns = [
      {
        ...
        render: (rowData) => (
          <Radio
            id={`radio${rowData.id}`}
            name="radSelected"
            value={rowData.user.person.id}
            checked={this.state.selectedValue === rowData.user.person.id}

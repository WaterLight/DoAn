...
import { getStoreByPage, deleteItem, getItemById, searchByPage } from "./KhoService";
import StoreEditorDialog from "./KhoEditorDialog";
...
class KhoTable extends React.Component {
  state = {
    keyword: '',
    rowsPerPage: 10,
    page: 0,
  ...
  handleConfirmationResponse = () => {
    ...
    deleteItem(this.state.id).then(() => {
      toast.info(t('Store.noti.deleteSuccess'));
      this.updatePageData();
  ...
  render() {
    ...
    let columns = [
      { title: t("Store.code"), field: "maKho", width: "150" },
      { title: t("Store.name"), field: "tenKho", align: "left", width: "150" },
      { title: t("Store.address"), field: "diaChi", align: "left", width: "150" },
      {

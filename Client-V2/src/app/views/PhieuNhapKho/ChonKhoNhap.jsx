...
class ChonKho extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("general.code"), field: "maKho", align: "left", width: "150" },
      { title: t("general.name"), field: "tenKho", width: "150" },
    ];
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'md'} fullWidth>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("Kho")}</span>
        </DialogTitle>
        <DialogContent>
          <Grid item xs={12}>
            <Input
